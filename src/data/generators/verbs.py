    ...
    def generate_perfekt_aux(self, count=1000):
        ...
        for _ in range(count):
            ...
            if random.random() > 0.4:
                ...
                data.append({"input": f"{sub_key.capitalize()} {c_aux} {item} {verb_p2}.", "output": "✅ Correct."})
        return data
    ...
    def generate_partizip_forms(self, count=1000):
        ...
        for _ in range(count):
            ...
            if random.random() > 0.4:
                ...
                data.append({"input": f"{sub_key.capitalize()} {aux} {obj} {p2}.", "output": "✅ Correct."})
        return data
    ...
    def generate_modal_verbs(self, count=1000):
        ...
        for _ in range(count):
            ...
            if rand > 0.7:
                ...
                data.append({"input": f"{sub_key.capitalize()} {m_form} {phrase}.", "output": "✅ Correct."})
        return data
    ...
    def generate_reflexive_verbs(self, count=1000):
        ...
        for _ in range(count):
            ...
            if random.random() > 0.4:
                ...
                data.append({"input": f"{sub_key.capitalize()} {v_form} {c_refl} {extra}.", "output": "✅ Correct."})
        return data

    def generate_praeteritum_essentials(self, count=1000):
        """A2: Präteritum."""
        scenarios = [("war", "sein", "вчора вдома"), ("hatte", "haben", "багато роботи")]
        data = []
        for _ in range(count):
            sub_key = random.choice(list(self.subjects.keys()))
            ...
            if random.random() > 0.4:
                ...
                data.append({"input": f"{sub_key.capitalize()} {c_form} {extra}.", "output": "✅ Correct."})
        return data
