> ⚠️ **Архів — v1.0 (Decoder-only).** Цей файл описує першу версію моделі: GPT-стиль, Decoder-only, `d_model=128`, словник 4 000 слів. Починаючи з v2.0 архітектура змінена на BART Encoder-Decoder. Актуальний опис: [architecture_v2.md](architecture_v2.md).

# Математична архітектура моделі (v1.0 — архів)
